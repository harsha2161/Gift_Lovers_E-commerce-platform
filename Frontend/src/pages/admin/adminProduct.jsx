...
export default function AdminProductPage(){
    ...
    <div className="w-full h-full overflow-y-auto p-6 bg-gray-200">
      <div className="overflow-x-auto h-full rounded-2xl shadow-xl relative">
        ...
        <Link to={"/admin/addproduct"}><button className="absolute bottom-5 right-5 bg-green-500 text-3xl text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition fixed top-140 right-15">
  +
</button>
</Link>
  </div>
